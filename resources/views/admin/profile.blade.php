              ...
              <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div class="col-md-12">
										...
										<input type="email" class="form-control" name="email" id="input2" placeholder="Enter Your Email" value="{{@$user->email}}">
									</div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    class="rounded-circle p-1 shadow mb-3" width="90" height="90" alt="">
									...
									<div class="col-md-12">
										...
										<textarea class="form-control" id="input11" name="address" placeholder="Enter Your Address" rows="4" cols="4">{{@$user->address}}</textarea>
									</div>
									<div class="col-md-12">
