    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Wall Poster</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('user-wallposter-store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-grd btn-grd-success px-5">Add Wall Poster</button>
                            </div>
