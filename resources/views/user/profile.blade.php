          ...
          <div class="card-body p-4">
            <div class="position-relative mb-5">
              ...
              <div class="profile-avatar position-absolute top-100 start-50 translate-middle">
                <img src="{{ !empty($user->image) ? url('/storage/user/'.$user->image) : url('no_image.jpg') }}" class="img-fluid rounded-circle p-1 bg-grd-danger shadow" width="170" height="170" alt="">
              </div>
            </div>
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  @csrf 
									<div class="col-md-12">
										...
										<input type="text" class="form-control" name="code" id="input1" placeholder="Enter Your Name" value="{{@$user->code}}" readonly>
									</div>
                  ...
                  <div class="col-md-12">
										...
										<input type="text" class="form-control" name="designation" id="input4" placeholder="Enter Your Designation" value="{{@$user->designation}}">
									</div>
                  <div class="col-md-12">
										<label for="input5" class="form-label">Aadhar</label>
										<input type="text" class="form-control" name="aadhar" id="input5" placeholder="Enter Your Aadhar Number" value="{{@$user->aadhar}}">
									</div>
