                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
                                <img src="{{ asset('admin/assets/images/county/01.png') }}" width="20"
                                    alt=""><span class="ms-2">English</span></a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
                                <img src="{{ asset('admin/assets/images/county/02.png') }}" width="20"
                        ...
                        <div class="border rounded-4 overflow-hidden">
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/01.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/02.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/03.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/04.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/05.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/06.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0 border-bottom">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/07.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/08.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/09.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                            ...
                            <div class="row row-cols-3 g-0">
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/10.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col border-end">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/11.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                                ...
                                <div class="col">
                                    <div class="app-wrapper d-flex flex-column gap-2 text-center">
                                        <div class="app-icon">
                                            <img src="{{ asset('admin/assets/images/apps/12.png') }}" width="36"
                                                alt="">
                                        </div>
                                        <div class="app-name">
                        ...
                        <div class="card-body">
                            <div class="">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <img src="{{ asset('admin/assets/images/apps/party-popper.png') }}"
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <img src="{{ asset('admin/assets/images/apps/gift-box-3.png') }}" width="100"
                                        alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div class="d-flex flex-column gap-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                            <img src="{{ asset('admin/assets/images/apps/twitter-circle.png') }}"
                                                width="40" alt="">
                                            <div>
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/top-products/01.png') }}"
                                        width="55" class="rounded-circle" alt="">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/top-products/05.png') }}"
                                        width="55" class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                ...
                <div class="col-12 col-lg-12 col-xxl-4 d-flex">
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/avatars/01.png') }}" width="55"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/avatars/02.png') }}" width="55"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/avatars/03.png') }}" width="55"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/avatars/04.png') }}" width="55"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('admin/assets/images/avatars/08.png') }}" width="55"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">Ajay Sidhu</h6>
                                        <p class="mb-0">Sale: 879</p>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="{{ asset('admin/assets/images/apps/paypal.png') }}"
                                                            width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="{{ asset('admin/assets/images/apps/behance.png') }}"
                                                            width="35" alt="">
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-3">
                                                    <div class="">
                                                        <img src="{{ asset('admin/assets/images/apps/apple.png') }}"
                                                            width="35" alt="">
                                                    </div>
                                                    <div class="">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
        ...
        <div class="offcanvas-body p-0">
            <div class="order-list">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="{{ asset('admin/assets/images/orders/06.png') }}" class="img-fluid rounded-3"
                            width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="{{ asset('admin/assets/images/orders/07.png') }}" class="img-fluid rounded-3"
                            width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
                ...
                <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                    <div class="order-img">
                        <img src="{{ asset('admin/assets/images/orders/08.png') }}" class="img-fluid rounded-3"
                            width="75" alt="">
                    </div>
                    <div class="order-info flex-grow-1">
